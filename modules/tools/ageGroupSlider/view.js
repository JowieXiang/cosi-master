import AgeGroupSliderTemplate from "text-loader!./template.html";

const AgeGroupSliderView = Backbone.View.extend({
    events: {
    ...
    template: _.template(AgeGroupSliderTemplate),
...
export default AgeGroupSliderView;
